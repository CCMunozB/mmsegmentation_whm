...
class LoadMultiAnnotations(MMCV_LoadAnnotations):
    """Load Multiple annotations for semantic segmentation provided by dataset.
    ...
    - seg_map_path (List): Path of semantic segmentation ground truth file.
    ...
    def _load_seg_map(self, results: dict) -> None:
        ...
        if self.reduce_zero_label:
            # avoid using underflow conversion
            for n,segmentation in enumerate(gt_semantic_seg_list):
                
                segmentation[segmentation == 0] = 255
                segmentation = segmentation - 1
                segmentation[segmentation == 254] = 255
                
                gt_semantic_seg_list[n] = segmentation

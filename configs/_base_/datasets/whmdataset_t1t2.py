...
data_root = 'data/WMH_t1t2'
crop_size = (224, 224)
train_pipeline = [
    dict(type='LoadImageFromFile', imdecode_backend='tifffile'),
    dict(type='LoadAnnotations'),
    dict(type='RandomRotate', prob=0.6, degree=15.0, seg_pad_val=0),
    dict(type='RandomFlip', prob=0.6),
    dict(type='ShearX', prob=0.6, max_mag=20.0, img_border_value=0),
    dict(type='ShearY', prob=0.6, max_mag=20.0, img_border_value=0),
